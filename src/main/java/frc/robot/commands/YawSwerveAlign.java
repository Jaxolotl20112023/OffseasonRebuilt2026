...
public class YawSwerveAlign extends Command {
    ...
    public YawSwerveAlign(CommandSwerveDrivetrain drivetrain, CommandXboxController controller, double desiredYaw) {
